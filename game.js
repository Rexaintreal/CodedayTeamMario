...
const CHARACTERS = [
  { id: 'mario',     name: 'Mario',     thumb: 'assets/mario2.png',                    sprite: 'assets/mario2.png' },
  { id: 'akif',      name: 'Akif',      thumb: 'assets/characters/akif.png',           sprite: 'assets/characters/akif48.png' },
  { id: 'avan',      name: 'Avan',      thumb: 'assets/characters/avan.png',           sprite: 'assets/characters/avan48.png' },
  { id: 'nityadidi', name: 'Nitya Didi',thumb: 'assets/characters/nityadidi.png',      sprite: 'assets/characters/nityadidi48.png' },
  { id: 'saksham',   name: 'Saksham',   thumb: 'assets/characters/saksham.png',        sprite: 'assets/characters/saksham48.png' },
  { id: 'shubh',     name: 'Shubh',     thumb: 'assets/characters/shubh.png',          sprite: 'assets/characters/shubh48.png' },
  { id: 'vansh',     name: 'Vansh',     thumb: 'assets/characters/vansh.png',          sprite: 'assets/characters/vansh48.png' },
];

let selectedCharacterId = localStorage.getItem('mario2_selectedChar') || CHARACTERS[0].id;

function spriteKey(id) { return 'charSprite_' + id; }
function thumbKey(id)  { return 'charThumb_' + id; }
...
for (const c of CHARACTERS) {
  ASSET_MANIFEST[spriteKey(c.id)] = c.sprite;
  if (c.thumb !== c.sprite) ASSET_MANIFEST[thumbKey(c.id)] = c.thumb;
}

function applySelectedCharacter() {
  const key = spriteKey(selectedCharacterId);
  ASSETS.player = ASSETS[key] || ASSETS[spriteKey('mario')];
}
...
function buildCharacterGrid() {
  ...
  for (const c of CHARACTERS) {
    ...
    card.className = 'char-card' + (c.id === selectedCharacterId ? ' selected' : '');
    ...
    card.addEventListener('click', () => {
      ...
      localStorage.setItem('mario2_selectedChar', c.id);
